            ...
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                <#if type == 1>
                  ...
                  <#else>
                    <img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.jpg" alt="${ylrc_student.name!""}" />
                  </#if>
                  <span>${ylrc_user.username!""} <span class="caret"></span></span>
                <#elseif type == 2>
                  <#if ylrc_judge.headPic??>
                    <#if ylrc_judge.headPic?length gt 0>
                      <img class="img-avatar img-avatar-48 m-r-10" src="/photo/view?filename=${ylrc_judge.headPic}" alt="${ylrc_judge.name!""}" />
                    <#else>
                      <img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.jpg" alt="${ylrc_judge.name!""}" />
                    </#if>
                  <#else>
                    <img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.jpg" alt="${ylrc_judge.name!""}" />
                  </#if>
                  <span>${ylrc_judge.name!""} <span class="caret"></span></span>
                <#elseif type == 3>
                  <#if ylrc_student.headPic??>
                    <#if ylrc_student.headPic?length gt 0>
                      <img class="img-avatar img-avatar-48 m-r-10" src="/photo/view?filename=${ylrc_student.headPic}" alt="${ylrc_student.name!""}" />
                    <#else>
                      <img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.jpg" alt="${ylrc_student.name!""}" />
                    </#if>
                  <#else>
                  ...
                  <span>${ylrc_student.name!""} <span class="caret"></span></span>
                </#if>
              </a>
