                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                              ...
                                              <#if pageBean.content?size gt 0>
                                                ...
                                                <tr>
                                                    <input type="hidden" name="competitionId" id="competitionId"
                                                           value="${personalCompetition.competition.id}">
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]"
                                                                   value="${personalCompetition.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    ...
                                                    <#if compeType!=4>
                                                         <td>
                                                        <#if compeType==2>
                                                            <#if personalCompetition.preliminariesStatus==1>
                                                                    <font style="color: green">已晋级</font>
                                                            <#else>
                                                                 <font style="color: red"></font>
                                                            </#if>
                                                        <#elseif compeType==3>
                                                            <#if personalCompetition.secondRoundStatus==0>
                                                           <font style="color: red"></font>
                                                            <#else >
                                                           <font style="color: green">已晋级</font>
                                                            </#if>
                                                    ...
                                                    <#else>
                                                     <td>${personalCompetition.finalsScore}</td>
                                                    <td>
                                                        <#if personalCompetition.finalsScoreStatus==0>
                                                    ...
                                                    <#if type==2>
                                                         <td>
                                                             <button class="btn btn-success btn-w-md" type="button"
                                                                     <#if timeType==0>
                                                                         <#if compeType == 2>
                                                                             <#if personalCompetition.preliminariesScoreStatus == 1>
                                                                                 disabled
                                                                             </#if>
                                                                         <#elseif compeType == 3>
                                                                             <#if personalCompetition.secondRoundScoreStatus == 1>
                                                                                 disabled
                                                                             </#if>
                                                                         <#else>
                                                                             <#if personalCompetition.finalsScoreStatus == 1>
                                                                                 disabled
                                                                             </#if>
                                                                         </#if>
                                                                     <#else>
                                                                     ...
                                                                     onclick="score(${personalCompetition.competition.id},${personalCompetition.id})">评分
                                                             </button>
                                                             <button class="btn btn-success btn btn-warning"
                                                                     type="button"
                                                                     <#if compeType == 2>
                                                                         <#if timeType==0>
                                                                             <#if personalCompetition.preliminariesStatus == 1>
                                                                     ...
                                                                     <#elseif compeType == 3>
                                                                         <#if timeType==0>
                                                                             <#if personalCompetition.secondRoundStatus == 1>
                                                                                 disabled
                                                                             </#if>
                                                                         <#else>
                                                                             disabled
                                                                     ...
                                                                     data-name="${personalCompetition.competition.id}"
                                                                     id="${personalCompetition.id}">
                                                                 晋级
                                                             </button>
                                ...
                                <ul class="pagination ">
                                    ...
                                    <#else>
                                        <li>
                                            <a href="viewPersionMatch?id=${competition.id!""}&currentPage=1&compeType=${compeType}">«</a>
                                        </li>
                                    </#if>
                                    <#list pageBean.currentShowPage as showPage>
                                        ...
                                        <#else>
                                            <li>
                                                <a href="viewPersionMatch?id=${competition.id!""}&currentPage=${showPage}&compeType=${compeType}">${showPage}</a>
                                            </li>
                                        </#if>
                                    </#list>
                                    ...
                                    <#else>
                                        <li>
                                            <a href="viewPersionMatch?id=${competition.id!""}&currentPage=${pageBean.totalPage}&compeType=${compeType}">»</a>
                                        </li>
                                    </#if>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="viewCompetition">评分1</h4>
            </div>
...
<script>
    ...
    function showTop() {
        ...
        window.location.href = '/admin/competition/showPersionTop?competitionId='+competitionId;
    }

    function exportTop() {
        var competitionId = ${competition.id};
        window.location.href = '/admin/competition/export_individual?competitionId='+competitionId;
    }
            ...
            success: function (data) {
                if (data.code == 0) {
                    showSuccessMsg('评分成功!', function () {
                        window.location.href = '/admin/competition/viewPersionMatch?id='+competitionId+'&compeType='+compeType;
                    })
                } else {
