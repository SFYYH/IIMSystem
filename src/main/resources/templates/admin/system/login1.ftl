...
<body style="background-image: url('/admin/images/bg.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%;">
    ...
    <div class="lyear-login">
        <div class="login-center">
            ...
            <form id="login-form" method="post">
                ...
                <div class="form-group has-feedback feedback-left">
                    <input type="text" placeholder="请输入您的账号" class="form-control required" name="username" id="username" tips="请填写账号" />
